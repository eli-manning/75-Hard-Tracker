    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: insets.bottom + 32 }]}>
        ...
        <Text style={styles.body}>
          ...
          {`USE OF SERVICE\n\nCrewDay is provided as-is for personal use. The app is designed to help you track personal challenges and daily habits. If you use 75 Hard mode, we are not affiliated with the creators of the 75 Hard program.\n\n`}
